...
//
// Sort is an ent field name from the Browse whitelist below; empty
// means "default" (created_at DESC). Dir is "asc" or "desc" — anything
// else is treated as desc.
//
...
// (for permission_mode / stop_reason / starred). Unknown keys are
// ignored — the allow-list is enforced by the handler.
